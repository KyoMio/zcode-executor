...
// 3.12 起没有 workspace/readState 了（PLAN-3.12.md 一节层 2，2026-09-18）：模型表本来就是我们自己写进
 ...
 * warnings 是给人看的中文字符串数组：配置 tiers 指的模型不存在、preferredProvider 不在表里、某档为空、
 * 握手对不上。打印与否归调用方。zcodePath / env 原样透传给子进程（测试注入用）。
 */
 ...
 * （`--version` 在 3.11 和 3.12 都打 0.16.5，PLAN-3.12.md 2026-09-18）。
 ...
 * （3.12.2 起 generateText 的思考等级走 selection.options.reasoningLevel，PLAN-3.12.md 一节层 4）。

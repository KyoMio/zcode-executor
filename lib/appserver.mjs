...
// verified.md「3.12.2 直连探针实测」表第 5 行（2026-09-18）：宿主模式下 app-server 每次模型请求前都发这个反向请求，等客户端
// 答 {headersApplied: true, requestAuth: {apiKey?, headers?}}，180 秒不答模型请求就失败。
// key 由 spawn 时给的 providerAuth 按 params.providerId 提供；没有就明说 headersApplied:false，
// 让回合立刻失败而不是等满 180 秒。

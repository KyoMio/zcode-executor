...
// createComplete({ client, workspace, selection, ... }) 返回 async ({ system, user }) => text。
// 参数形状出处：docs/verified.md「workspace/generateText」行（params 带 workspace、messages（至少一个）、
// querySource（必填）、maxOutputTokens?、operationId?），3.12.2 起 modelRef 改名 selection、形状同
// session/create 的 model：{providerId, modelId, options?: {reasoningLevel}}，思考等级走
// options.reasoningLevel（verified.md「3.12.2 直连探针实测」表第 4 行，2026-09-18）。
 ...
 * @param {object} opts.selection {providerId, modelId, options?: {reasoningLevel}}（buildModelSelection）
